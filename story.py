def Story():
    ...
    print("Okay, *INSERT NAME HERE SOONTM* might as well fill you in on what you missed. It seems that you have missed quite a lot, not sure how... but you did. Basically, the entire land of Algoraea has been thrust into a civil war!\n"
            ...
            "The proud old king, Yovlosh, in a fit of rage and pure delusion, declared that any subject who has ancestral blood ties to dwarves, elves, and anything of the like.\n"
            ...
            "are to be expunged for their tainted blood. As to be expected, those who were loyal to the king obeyed his rule, but even those who were soon to be ostracized and murdered for just existing\n"
            "were starting to fall in line with the decree, simply out of fear and hope that if they were to submit to a lesser life of slavehood, woodland and mountain living, and through the extreme process of being\n"
            "sterilized through magic. I am unsure of how you have escaped this tragedy so far, but I fear that you will be soon thrust into this civil war. No one comes out of these sorts of things unscathed, and\n"
            "especially those who look as innocent as you.\n"
            "By the way...", end=" ")
    ...
    "It's been almost 200 years since anyone has laid eyes on someone from", birthPlace,".\n"
    ...
    print("Well, anyway, now that you're up to snuff,\n")
    toContinue=str(input("Are you ready to continue? Yes or no?"))
    if toContinue.lower() in ['y', "yes", "sure", "ok", "okay", "ye", "yep"]:
        print("Ah good, now we can *actually* get goin', my feet were starting to fall asleep from just standin' around")
